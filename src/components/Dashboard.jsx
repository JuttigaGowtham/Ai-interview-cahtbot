...
const ProgressCircle = ({ percentage, value, label, subLabel, size = 110, strokeWidth = 8 }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-between text-center bg-neutral-900/70 border border-neutral-800 p-4 md:p-6 rounded-2xl shadow-lg backdrop-blur-sm w-full h-full">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-transparent">
            <div className="max-w-4xl mx-auto">
                 <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-neutral-200">Interview Dashboard</h2>
                      <button onClick={switchToChat} className="flex items-center gap-2 text-sm bg-neutral-800 hover:bg-neutral-700 text-neutral-300 px-4 py-2 rounded-full transition-colors self-start md:self-center">
                        <ArrowLeftIcon />
                        Back to Chatbot
                    </button>
                </div>
                ...
                <div className="bg-neutral-900/70 border border-neutral-800 rounded-lg shadow-lg backdrop-blur-sm overflow-hidden">
